...
{
    public partial class Import : SecureBasePage
    {
        ...
        private int _studentColCount = 89;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Session["StaffID"] = SessionData.StaffID.Value;
            Session["CustomerID"] = SessionData.CustomerID.Value;
        }
        ...
        private void ImportInfrastructure()
        {
            try
            {
                ...
                CurrentFile = "None";
                if (!(fuOrg.HasFile || fuStaff.HasFile || fuStudent.HasFile))
                {
                    tbMessage.Text = "Either you have not selected a file to upload or the file is empty.";
                ...
                if (GetErrorCount() < 1)
                {
                    ...
                    if (_staffFile == false || Confirmation())
                    {
                        ...
                        if (GetErrorCount() < 1)
                        {
                            ...
                            LogMessage(0, 0, "File Upload Batch " + BatchId
            ...
            {
                CurrentFile = "Abort Message";
                LogMessage(9, 0, "File could not be uploaded due to -- " + ex);
                tbMessage.Text = "Errors Found -- See list below";
                tbMessage.Visible = true;
                tbMessage.CssClass = "errorMessage";
                //throw (ex);
        ...
        private DataTable CreateDataTableFromFile(StreamReader sr, int columnCount, string fileExtension)
        {
            ...
            while ((input = sr.ReadLine()) != null)
            {
                ...
                {
                    throw new ArgumentException("Input row invalid number of colums, batch " + BatchId + " customer " + CustomerId.ToString() + " row " + RowId.ToString() + "expected " + columnCount.ToString() + " found " + s.Length.ToString() + ".");
                }
                else
                {
                    dr = dt.NewRow();
        ...
        private void GetBatchId()
        {
            ...
            userParams[1] = new SqlParameter("@userID", SessionData.Staff.StaffID.Value);
            ...
            tbBatchID.Text = BatchId.ToString();
        }
        ...
        {
            PageID = 46; //Value from Page Table in db
        }
