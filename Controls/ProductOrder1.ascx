<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductOrder1.ascx.cs" Inherits="BDI2Web.Controls.ProductOrder1" %>
...
<asp:MultiView ID="mvMain" runat="server" ActiveViewIndex="0">
    <asp:View ID="viewOrder" runat="server">
        <asp:ValidationSummary DisplayMode="BulletList" runat="server" EnableClientScript="true" ValidationGroup="ProductOrder" />
        <asp:Label ID="ErrorLabel" runat="server" SkinID="ErrorMessage" Text="" />
                        ...
                        <asp:MultiView ID="mvPaymentTypes" runat="server" ActiveViewIndex="0">
                            <asp:View ID="viewCC" runat="server">
                                ...
                                <table cellpadding="1" cellspacing="0">
                                    <tr>
                                        <td class="title">Credit Card:<asp:Label ID="Label1" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorPaymentType" ControlToValidate="btnlstPaymentType" runat="server" 
                                                Display="None" SetFocusOnError="true" ErrorMessage="A Credit Card type is required." ValidationGroup="ProductOrder"  />
                                        </td>
                                        <td>
                                ...
                                <table cellpadding="1" cellspacing="1" >
                                    ...
                                    <tr>
                                        <td class="text">Card&nbsp;Number:<asp:Label ID="Label2" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                    ...
                                    <tr>
                                        <td class="text">CC&nbsp;Exp&nbsp;Date:<asp:Label ID="Label3" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                            ...
                                            <asp:CustomValidator ID="ExpDateCustomValidator" ControlToValidate="txtCCExpDate" SetFocusOnError="true" Display="None" 
                                              ValidationGroup="ProductOrder" OnServerValidate="ValidateCCDate" runat="server"></asp:CustomValidator>                  
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCCExpDate" MaxLength="10" runat="server" Width="200px" TabIndex="4" Text='<%#Bind("CCExpDate")%>'/>
                            ...
                            <asp:View ID="viewPO" runat="server">
                                ...
                                <table cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="text">Purchase Order Number:<asp:Label ID="Label5" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                            <asp:RequiredFieldValidator ControlToValidate="txtPONumber" ErrorMessage="A Purchase Order Number is Required" ValidationGroup="ProductOrder" ID="RequiredFieldValidatorPONumber" runat="server"  
                                                SetFocusOnError="true" Display="None" EnableClientScript="true">
                                            </asp:RequiredFieldValidator>                                               
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text">Cert. Expiration Date:<asp:RegularExpressionValidator ControlToValidate="txtPOCertExpDate" ErrorMessage="Invalid Cert Expiration Date." ValidationGroup="ProductOrder" ID="RegularExpressionValidatorPOCertExpDate" runat="server" 
                                                SetFocusOnError="true" Display="Static" Text="*"
                                                ValidationExpression="((0?[13578]|10|12)(-|\/)((0[0-9])|([12])([0-9]?)|(3[01]?))(-|\/)((\d{4})|(\d{2}))|(0?[2469]|11)(-|\/)((0[0-9])|([12])([0-9]?)|(3[0]?))(-|\/)((\d{4}|\d{2})))">
                                            </asp:RegularExpressionValidator>                       
                                        </td>
                                        <td>
                                            ...
                                            <asp:ImageButton runat="Server" ID="imgPOCertExpDate" ImageUrl="~/Images/Calendar.gif" AlternateText="Click to show calendar" ImageAlign="AbsMiddle" />
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <table cellpadding="1" cellspacing="1">
                                ...
                                <tr>
                                    <td class="text">Name:<asp:Label ID="Label7" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                ...
                                <tr>
                                    <td class="text">Billing Address:<asp:Label ID="Label8" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                ...
                                <tr>
                                    <td class="text">City:<asp:Label ID="Label9" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                ...
                                <tr>
                                    <td class="text">State:<asp:Label ID="Label10" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                ...
                                <tr>
                                    <td class="text">Zip Code:<asp:Label ID="Label11" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                ...
                                <tr>
                                    <td class="text">Phone:<asp:Label ID="Label12" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                ...
                                <tr>
                                    <td class="text">E-mail Address:<asp:Label ID="Label13" runat="server" SkinID="Info" Text="*" Width="5px"></asp:Label>
                                ...
                                <ContentTemplate>
                                    <table cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlShipToState" runat="server" AutoPostBack="true" DataSourceID="dsStates" DataTextField="Abbreviation" DataValueField="stateID" TabIndex="20" Text='<%#Bind("ShipToState")%>' OnSelectedIndexChanged="ddlShipToState_OnSelectedIndexChange" />
                                                <asp:DropDownList ID="ddlShiptoStateRates" runat="server" AutoPostBack="false" DataSourceID="dsStates" DataTextField="Abbreviation" DataValueField="Rate" Visible="False"  Text='<%#Bind("ShipToState")%>'  />
                                                <asp:UpdatePanel ID="upnlPopulateStateTaxRate" runat="server">
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="ddlShipToState" EventName="SelectedIndexChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="text">E-mail Address:
                                                <asp:RegularExpressionValidator ControlToValidate="txtShipToEmail" ErrorMessage="Invalid Ship To E-mail Address." ValidationGroup="ProductOrder" ID="RegularExpressionValidatorShipToEmail" runat="server" 
                                                    SetFocusOnError="true" Display="Static" Text="*"
                                                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">
                                                </asp:RegularExpressionValidator>                            
                                            </td>
                    ...
                    <tr>
                        <td colspan="3" style="text-align:center; padding-top:10px;" >
                            <asp:Button ID="btnShipSameAsBill" runat="server" Text="Use the Billing Address for Shipping also" OnClick="btnShipSameAsBill_Click" TabIndex="15" />
                        </td>
                    </tr>
                </table>
            </InsertItemTemplate>
                        ...
                        <ContentTemplate>
                            <table>
                                <tbody style="text-align:right;">
                                    ...
                                    <tr>
                                        <td class="subtitle">Sales Tax Rate:</td>
                                        <td><asp:TextBox ID="txtSalesTaxRate" Width="50px" runat="server" />
                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" TargetControlID="txtSalesTaxRate" runat="server"
                                                FilterType="Custom, Numbers" ValidChars=".">
                                            </ajaxToolkit:FilteredTextBoxExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="subtitle" >Estimated State Sales Tax:</td>
                                        <td><asp:label ID="lblTax" runat="server" SkinID="Title"/></td>
                                    </tr>
                                    <tr>
                                        <td class="subtitle"  style="border-bottom:1px solid black;">Estimated Shipping and Handling*:</td>
                                        <td style="border-bottom:1px solid black;">
                                            <asp:Label ID="lblSH" runat="server" SkinID="Title"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="subtitle" >Estimated Order Total:</td>
                                        <td rowspan="5" style="width:5px;">&nbsp;</td>
    ...
    <asp:View ID="viewConfirm" runat="server" EnableViewState="false">
                ...
                <td>
                    <table>
                        <tbody style="text-align:right;">
                            ...
                            <tr>
                                <td class="subtitle">Sales Tax Rate:</td>
                                <td><asp:Label ID="lblSalesTaxRate" runat="server"/></td>
                            </tr>
                            <tr>
                                <td class="subtitle" >Estimated State Sales Tax:</td>
        ...
        <div style="text-align:center; padding-top:15px;">            
            <asp:Button ID="btnSaveOrder" Text="Process Order" runat="server" Width="150px" ToolTip="Proceed with the Order" OnClientClick="return confirm('Do you wish to proceed with your order?');" OnClick="btnSaveOrder_Click" />&nbsp;&nbsp;&nbsp;
    ...
    <asp:View ID="viewThanks" runat="server">
        <div class="title" style="padding-top:20px; text-align:center; width:290px;">
            <div style="padding:10px;">Your order has been submitted</div>
...
<asp:SqlDataSource ID="dsStates" runat="server" ConnectionString="<%$ ConnectionStrings:LocalSqlServer %>"
    ...
    SelectCommand="SELECT Abbreviation, CAST(Rate as varchar(5)) as Rate, stateID FROM CustomerService.States
                   UNION SELECT '','0', 0
...
<asp:SqlDataSource ID="dsNewOrder" runat="server" ConnectionString="<%$ ConnectionStrings:LocalSqlServer %>"        
    ...
    <InsertParameters>
        ...
        <asp:Parameter Name="CCExpDate" Type="String" ConvertEmptyStringToNull="true"/>
        ...
        <asp:Parameter Name="TaxCertExpDate" Type="String" ConvertEmptyStringToNull="true"/>
